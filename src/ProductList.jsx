...
function ProductList() {
    ...
    const addToCart = (plant) => {
        setCart([...cart, plant]); // Add plant to cart
        alert(`${plant.name} added to cart!`); // Optional: Provide user feedback
    };
    ...
    return (
        <div>
            <div className="navbar" style={styleObj}>
                ...
                <div style={styleObjUl}>
                    ...
                    <div> <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}><h1 className='cart'>
                        <span style={styleCartCount}>{cartCount}</span>
            ...
            {!showCart ? (
                ...
                <CartItem onContinueShopping={handleContinueShopping} onCartQuantityUpdate={handleCartQuantityUpdate} />
            )}
        </div>
    );
}
